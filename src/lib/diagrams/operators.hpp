...
namespace mix::dd
{
    ...
    template<std::size_t P = 2, domain_e Domain = domain_e::homogenous>
    struct NAND : public bin_op<utils::logical_nand_t, P, Domain, 0> {};

    template<std::size_t P = 2, domain_e Domain = domain_e::homogenous>
    struct NOR : public bin_op<utils::logical_nor_t, P, Domain, 1> {};
    ...
    template<std::size_t P, domain_e Domain = domain_e::nonhomogenous>
    struct MIN : public bin_op<utils::min_t, P, Domain, 0> {};

    template<std::size_t P, domain_e Domain = domain_e::nonhomogenous>
    struct MAX : public bin_op<utils::max_t, P, Domain, P - 1> {};
