...
BOOST_AUTO_TEST_CASE(operators_2)
{
    ...
    BOOST_REQUIRE_EQUAL(NOT_EQUAL_TO()(2,2), 1);
    ...
    BOOST_REQUIRE_EQUAL(LESS_EQUAL()(1,N), 0);
    ...
    BOOST_REQUIRE_EQUAL(GREATER()(2,N), 0);
    ...
    BOOST_REQUIRE_EQUAL(GREATER_EQUAL()(0,N), 0);
    ...
    BOOST_REQUIRE_EQUAL(IMPLIES()(0,N), N); // TODO could be 1
